      ...
      {rem.map((e, index) => (
        ...
        >
          <div className="flex h-full w-full flex-row">
            {anime && (
              <Tooltip content={'Ir a la página del anime.'}>
            ...
            <Tooltip
              content={
                currAnime ? 'Ir al reproductor.' : 'Solo hay metadatos disponibles para este anime.'
              }
            >
              <div
              ...
              >
                ...
                <div className="my-2 ml-1 grid grid-cols-[repeat(auto-fit,minmax(190px,1fr))] gap-x-4 gap-y-2">
                  ...
                  <p className="flex w-48 items-center justify-start gap-x-2 text-sm">
                    {(e.progress * 100).toFixed(2)}% Completado
                  </p>
                  <p className="flex w-48 items-center justify-start gap-x-2 text-sm">
                    {formatBytes(e.downloaded)} Descargado
                  </p>
                  <p className="flex w-48 items-center justify-start gap-x-2 text-sm">
                    {formatBytes(e.uploaded)} Subido
                  </p>
                </div>
