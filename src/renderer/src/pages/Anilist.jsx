  ...
  return (
    <div className="w-full select-none p-10 px-5 font-space-mono tracking-tight">
      <div className="flex w-full items-center justify-between gap-x-5">
        ...
        <div className="grid items-center gap-5 md:grid-cols-4 lg2:grid-cols-5 xl:flex">
                ...
                <Button variant="ghost" color="gray">
                  <div className="flex animate-fade items-center gap-x-2">
                    <div className="flex items-center gap-2 font-inter text-[.8rem] tracking-wider">
                      <MountainsLogo />
                      {genre ? genre[1] + genre.replace(/"/g, '').slice(1).toLowerCase() : 'GÉNERO'}
                    </div>
                  </div>
                ...
                <Button variant="ghost" color="gray">
                  <div className="flex animate-fade items-center gap-x-2">
                    <div className="flex items-center gap-2 font-inter text-[.8rem] tracking-wider">
                      ...
                      {season ? season[0] + season.slice(1).toLowerCase() : 'TEMPORADA'}
                    </div>
                  </div>
                  <DropdownMenu.TriggerIcon />
                </Button>
      ...
      {!infiniteQueryError &&
        ...
        !working && (
          <div className="mt-10 flex w-full animate-fade justify-center">
            <ErrorElement
              title={'¡No se encontró anime!'}
              text={'¿Estás seguro de que ingresaste el título correcto?'}
              type={'info'}
            />
