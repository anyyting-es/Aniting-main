...
export default function HentaiHome() {
  ...
  const {
    ...
    {
      sort: 'TRENDING_DESC', // Hentai doesn't always have RELEASING
      format_not: 'MUSIC'
    },
    1,
    49
  ...
  useEffect(() => {
    if (infiniteQueryError) {
      toast.error(`Error al obtener los Mejores Hentai`, {
