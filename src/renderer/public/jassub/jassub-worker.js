async function Module(moduleArg = {}) {
  ...
  var PThread = {
    ...
    initMainThread() {
      var pthreadPoolSize =
        !navigator.userAgent.toLowerCase().includes('firefox') && self.crossOriginIsolated
          ? Math.min(Math.max(0, navigator.hardwareConcurrency - 2), 8)
          : 0
    ...
    allocateUnusedWorker() {
      var worker
      worker = new Worker(new URL('jassub-worker.js', import.meta.url), {
        type: 'module',
        name: 'em-pthread'
      })
      PThread.unusedWorkers.push(worker)
  ...
  function ___syscall_getdents64(fd, dirp, count) {
    if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(3, 0, 1, fd, dirp, count)
  }
  ...
  function _fd_seek(fd, offset, whence, newOffset) {
    if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(11, 0, 1, fd, offset, whence, newOffset)
  ...
  function assignWasmExports(wasmExports) {
    __ZdlPvm = Module['__ZdlPvm'] = wasmExports['Z']
    _malloc = Module['_malloc'] = wasmExports['_']
    _free = wasmExports['$']
    _calloc = Module['_calloc'] = wasmExports['aa']
    ___getTypeName = wasmExports['ba']
    __embind_initialize_bindings = wasmExports['ca']
    _pthread_self = wasmExports['da']
    _emscripten_builtin_free = Module['_emscripten_builtin_free'] = wasmExports['ea']
    __emscripten_tls_init = wasmExports['fa']
    __emscripten_thread_init = wasmExports['ha']
    __emscripten_thread_crashed = wasmExports['ia']
    ___libc_free = Module['___libc_free'] = wasmExports['ja']
    _emscripten_builtin_malloc = Module['_emscripten_builtin_malloc'] = wasmExports['ka']
    ___libc_malloc = Module['___libc_malloc'] = wasmExports['la']
    ...
    __ZdaPv = Module['__ZdaPv'] = wasmExports['ra']
    __ZdaPvm = Module['__ZdaPvm'] = wasmExports['sa']
    __ZdlPv = Module['__ZdlPv'] = wasmExports['ta']
    __Znaj = Module['__Znaj'] = wasmExports['ua']
    __ZnajSt11align_val_t = Module['__ZnajSt11align_val_t'] = wasmExports['va']
    __Znwj = Module['__Znwj'] = wasmExports['wa']
    __ZnwjSt11align_val_t = Module['__ZnwjSt11align_val_t'] = wasmExports['xa']
    ___libc_calloc = Module['___libc_calloc'] = wasmExports['ya']
    ___libc_realloc = Module['___libc_realloc'] = wasmExports['za']
    _emscripten_builtin_calloc = Module['_emscripten_builtin_calloc'] = wasmExports['Aa']
    _emscripten_builtin_realloc = Module['_emscripten_builtin_realloc'] = wasmExports['Ba']
    _malloc_size = Module['_malloc_size'] = wasmExports['Ca']
    _malloc_usable_size = Module['_malloc_usable_size'] = wasmExports['Da']
    _reallocf = Module['_reallocf'] = wasmExports['Ea']
